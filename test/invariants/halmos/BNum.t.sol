...
contract SymbolicBNum is BNum, SymTest, Test {
  ...
  function check_btoi_alwaysFloor(uint256 _input) public {
  ...
  // btoi should always return the floor(a / BONE) == (a - a%BONE) / BONE
  function check_bfloor_shouldAlwaysRoundDown(uint256 _input) public {
  ...
  function check_baddCommut(uint256 _a, uint256 _b) public {
  ...
  function check_badd_assoc(uint256 _a, uint256 _b, uint256 _c) public {
  ...
  function check_badd_zeroIdentity(uint256 _a) public {
    uint256 _result = badd(_a, 0);
    assert(_result == _a);
  }

  // badd result should always be gte its terms
  function check_badd_resultGTE(uint256 _a, uint256 _b) public {
  ...
  function check_badd_overflow(uint256 _a, uint256 _b) public {
  ...
  function check_badd_bsub(uint256 _a, uint256 _b) public {
    uint256 _result = badd(_a, _b);
  ...
  function check_bsub_zeroIdentity(uint256 _a) public {
  ...
  function check_bsub_revert(uint256 _a, uint256 _b) public {
    vm.assume(_b > _a);
    //bsub(_a, _b);
  }
  ...
  function check_bsubSign_negative(uint256 _a, uint256 _b) public {
    vm.assume(_b > _a);
  ...
  function check_bsubSign_positive(uint256 _a, uint256 _b) public {
    vm.assume(_a > _b);
    (uint256 _result, bool _flag) = bsubSign(_a, _b);
    assert(_result == _a - _b);
    assert(!_flag);
  ...
  function check_bsubSign_zero(uint256 _a) public {
  ...
  function check_bmul_commutative(uint256 _a, uint256 _b) public {
  ...
  // function check_bmul_associative(uint256 _a, uint256 _b, uint256 _c) public {
  ...
  // function check_bmul_distributive(uint256 _a, uint256 _b, uint256 _c) public {
  ...
  // function check_bmul_identity(uint256 _a) public {
  ...
  function check_bmul_absorbing(uint256 _a) public {
  ...
  // function check_bmul_resultGTE(uint256 _a, uint256 _b) public {
  ...
  //todo
  //works with "1" then _result == _a*BONE
  // 1 should be identity for bdiv
  // function check_bdiv_identity(uint256 _a) public {
  ...
  // function check_bdiv_revert(uint256 _a) public {
  // }

  //todo
  // bdiv result should be lte a
  // function test_bdiv_resultLTE(uint256 _a, uint256 _b) public {
  //     vm.assume(_b != 0);
  //     vm.assume(_a < type(uint256).max / BONE); // Avoid mul overflow
  ...
  // function check_bdiv_bmul(uint256 _a, uint256 _b) public {
  //     vm.assume(_b > 0);
  ...
  function check_bpowi_zeroExp(uint256 _a) public {
   ...
   *   function check_bpowi_distributiveBase(uint256 _base, uint256 _a, uint256 _b) public {
   ...
   *   function check_bpowi_distributiveExp(uint256 _a, uint256 _b, uint256 _exp) public {
   ...
   *   function check_bpowi_powerOfPower(uint256 _base, uint256 _a, uint256 _b) public {
  ...
  function check_bpow_zeroExp(uint256 _a) public {
  ...
  //todo
  // 0 should be absorbing if base
  // function check_bpow_absorbingBase(uint256 _exp) public {
  ...
  // function check_bpow_distributiveBase(uint256 _base, uint256 _a, uint256 _b) public {
  ...
  // function check_bpow_distributiveExp(uint256 _a, uint256 _b, uint256 _exp) public {
  ...
  // todo
  // // power of a power should mult the exp (x^a)^b == x^(a*b)
  // function check_bpow_powerOfPower(uint256 _base, uint256 _a, uint256 _b) public {
